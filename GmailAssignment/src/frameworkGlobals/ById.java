...
public class ById extends BrowserSelection implements DriverActions{
	...
	public void click(String selector, String actionInfo) {
		...
		try {
			alerts.acceptAlert();
			WebElement element = getDriver().findElement(By.id(selector));
	...
	public int getSize(String selector, String actionInfo) {
		...
		try {
			...
			/*WebElement element = getDriver().findElement(By.id(selector));
			new JSExecutor().highlightElement(element);*/
			List<WebElement> options = getDriver().findElements(By.id(selector));
	...
	public List<WebElement> getElements(String selector, String actionInfo) {
		...
		try {
			alerts.acceptAlert();
			elementList = getDriver().findElements(By.id(selector));
