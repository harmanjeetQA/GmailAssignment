...
public class ByName extends BrowserSelection implements DriverActions{
		...
		public void click(String selectorName, String actionInfo) {
			...
			try {
				alerts.acceptAlert();
				WebElement element = getDriver().findElement(By.name(selectorName));
		...
		public int getSize(String selectorName, String actionInfo) {
			...
			try {
				...
				/*WebElement element = getDriver().findElement(By.name(selectorName));
				new JSExecutor().highlightElement(element);*/
				List<WebElement> options = getDriver().findElements(By.name(selectorName));
		...
		public List<WebElement> getElements(String selectorName, String actionInfo) {
			...
			try {
				alerts.acceptAlert();			
				//ALert Check Method need to implement here
				elementList = getDriver().findElements(By.name(selectorName));
